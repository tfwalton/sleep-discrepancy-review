...
author:
  - name: '**Tom F. Walton**'
    affil: 1
    main: true
    orcid: '0009-0002-5036-6740'
    email: tom.fioccowalton@research.uwa.edu.au
    web: https://github.com/tfwalton
  - name: Melissa J. Ree
    affil: 1
...
affiliation:
  - num: 1
    address: School of Psychological Science, The University of Western Australia
  - num: 2
    address: CALHN Neuropsychology, Royal Adelaide Hospital
  - num: 3
    address: School of Population and Global Health, The University of Western Australia
  - num: 4
    address: Office of the Deputy Vice Chancellor, Research, The University of Western Australia
main_findings:
  - "There are **different types** of **sleep discrepancy** and **huge problems** with the way these have been investigated to date"
