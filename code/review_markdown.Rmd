...
```{r SOL, echo = FALSE, warning = FALSE, message = FALSE, fig.cap = "SOL definitions", fig.height = 4}
#-------------------------------- SOL Bar Plot --------------------------------|
...
``` {r methodrm, echo = FALSE, warning = FALSE, message = FALSE, fig.cap = "Methods for handling repeated measurements", fig.height = 5}
...
```{r group, echo = FALSE, warning = FALSE, message = FALSE, fig.cap = "Statistical methods for comparing self-report and objective sleep", fig.height = 5}
...
``` {r otherm, collapse = TRUE, echo = FALSE, warning = FALSE, message = FALSE, fig.cap = "Other methods for operationalising sleep discrepancy", fig.height = 1.75}
...
df <- subset(screen, select = c(ama_cite, bibkey_apalatex, country, country2,
...
df$ama_cite <- paste0(df$ama_cite, df$bibkey_apalatex)
...
df$ama_cite <- paste(df$ama_cite, df$bibkey_apalatex)
df <- df[,-2]
