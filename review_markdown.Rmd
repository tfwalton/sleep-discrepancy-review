...
This manuscript, including all tables and figures summarising data were generated using computationally reproducible methods from master charting table available at (github link) [@piccolo2016; @lindsay2023].
...
The advantages of actigraphy include cost-effectiveness, ease of obtaining multiple nights of recording, and reduced invasiveness relative to PSG.  



<!-- Above will depend on sleep parameter and other things--not true--disagree--need to rephrase this section -->

Sleep onset has been emphasised as a gradual process (Tryon 2004) different phases of the process of sleep onset

That PSG and actigraphy tend to be systematically discrepant themselves indicates that they may represent different forms of sleep discrepancy
