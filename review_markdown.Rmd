...
A review protocol was registered before the review was conducted and is available at https://osf.io/bcjnq/. Deviations from the protocol are listed below <!--where?-->. <!--Two reviewers necessary for charting the data?--> The review was conducted according to up-to-date guidelines provided by the JBI scoping review methodology group [@Peters2020].
