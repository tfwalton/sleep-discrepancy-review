...
Sleep discrepancy, the discordance between self-report and objective measures of sleep is a common and important feature of insomnia disorder and a central issue for the measurement of sleep. Sleep discrepancy has been investigated in diverse ways in the literature and comprehensive discussions of conceptual implications and methodology are lacking. We conducted a scoping review to examine how sleep discrepancy has been conceptualised in the literature and identify what methods have been used to investigate it. The objectives, inclusion criteria, and methods for this scoping review were specified in advance and documented in a protocol [@Walton2022].

## Method

We searched MEDLINE (Ovid), Embase (Ovid), PsycInfo (Ovid), CINAHL Plus, PubMed, Scopus, and Web of Science for relevant studies. Titles and abstracts, and then full text records of searched studies were screened. Methodological information was extracted including measures of self-report and objective sleep, sleep variables, discrepancy indices, handling of repeated measurements, and method of measure comparison.

## Results

`r nrow(screen) %>% english() %>% str_to_sentence` studies were included in this review. Studies varied according to objective sleep measure, actigraphy algorithm, software, and rest interval, polysomnography setting and scoring criteria, sleep variables, self-report sleep measure, number of nights of objective recording, timeframe of self-report measure, self-report sleep variable definition, sleep discrepancy composite index, presence and handling of repeated measurements, and statistical method for measure comparison. The conceptual implications for these methodological parameters were discussed.

## Conclusions

<!-- paragraph unfinished -->

Three major forms of sleep discrepancy were identified, according to the breadth of their definition. <!-- Which are? --> Overall, there is considerable conceptual and methodological diversity in the sleep discrepancy literature, the size of and breadth of which has been underestimated to date. <!-- which has implications for?. -->

# Introduction

Sleep is measured in two principal ways: objectively through polysomnography or actigraphy, and by self-report through questionnaires or sleep diaries. The discordance that can exist between these two forms of measurement is known as subjective-objective sleep discrepancy, or more simply, sleep discrepancy. Sleep discrepancy is a common feature of insomnia disorder, where it is also referred to as sleep misperception or paradoxical insomnia. Individuals with insomnia tend to underestimate total sleep time (TST), and overestimate sleep onset latency (SOL) and wake after sleep onset (WASO) relative to objective measures [@Baglioni2014; @Edinger1995; @Means2003].\

Research in sleep discrepancy is marked by considerable conceptual and methodological diversity. Sleep discrepancy may be conceptualised as a spectrum [e.g, @Trajanovic2007], ranging from positive (self-report exceeds objective) to negative (objective exceeds self-report), or as an absolute measurement [e.g., @Baillet2016]. Sleep discrepancy may be found in a range of sleep variables including TST, SOL, WASO, or number of awakenings. Considered broadly, sleep discrepancy can also be extended beyond these sleep time-based measures and may represent discordance in self-report and objective sleep patterns [e.g., @AlLawati2021], or sleep quality. Sleep discrepancy research also varies in its primary objective. Whilst some research aims to compare self-report and objective sleep within a particular sample (e.g., using intra-class correlations or Bland-Altman plots), other studies aim to characterise the relationship between sleep discrepancy and another variables. Research of the latter variety usually involves deriving variables to define sleep discrepancy quantitatively, for example, subtracting self-report TST from objective TST to form a difference score [e.g., @Cronlein2019]. There are a range of different ways these derived variables are composed, each with their own conceptual and methodological implications.\

To date, there have been few systematic attempts to synthesise the available research and compare and evaluate the varied approaches to investigating sleep discrepancy. Two reviews have been conducted in this area. @Castelnovo2019 conducted a systematic review of quantitative definitions of paradoxical insomnia, an insomnia subvariant defined, in part, by the presence of sleep discrepancy. The scope of the review, however, was restricted to paradoxical insomnia only and excluded studies where sleep discrepancy was not used to form diagnostic criteria. A second review was conducted by @Rezaie2018 ---a literature review of the clinical features, aetiology, correlates, and treatment of sleep discrepancy and paradoxical insomnia. Whilst an informative discussion of research findings, this study eschewed a focus on methodological approaches and conceptualisations of sleep discrepancy and did not incorporate a systematic search, therefore likely underrepresenting the breadth of the literature. Interpretation of the findings of sleep discrepancy research is largely contingent upon the ways that sleep discrepancy has been operationalised and a review with a focus on such a consideration would be timely. A scoping review is a method of research synthesis that aims to map existing literature in a field of interest and identify types of evidence available in a given topic [@Arksey2005]. We used a scoping review strategy to examine how sleep discrepancy has been conceptualised in the literature and identify the methods used to investigate it. A preliminary search of Medline (Ovid), the Cochrane Library, Embase (Ovid), and PsycInfo (Ovid) was conducted to identify existing or in-progress systematic or scoping reviews on the topic. Except for the two reviews mentioned above, no records were identified.

# Method

A review protocol was registered before the review was conducted and is available at <!-- (OSF: link) -->. Deviations from the protocol are listed below <!--where?-->. <!--Two reviewers necessary for charting the data?--> The review was conducted according to up-to-date guidelines provided by the JBI scoping review methodology group [@Peters2020].

## Identifying studies

The search strategy aimed to identify articles published in peer-reviewed journals in addition to grey literature including theses, dissertations, and conference abstracts. Due to the large number of records returned by initial searches, grey literature was excluded from full text extraction (see PRISMA flowchart in Figure 1 for details). The following databases were searched: MEDLINE (Ovid), Embase (Ovid), PsycInfo (Ovid), CINAHL Plus, PubMed, Scopus, Web of Science, ProQuest Theses and Dissertations, and OSF Preprints. The search strategy included keywords, index terms, and search operators adapted for each database. Searches across all databases were conducted on the 24th April 2022. The full search strategy for Embase (Ovid) is provided as an example in Table \@ref(tab:embase) below. See supplemental materials for search terms for the other databases.\

```{r embase, echo = FALSE, warning = FALSE, message = FALSE}

embasetbl <- read.csv("C:/Users/tfioc/Documents/sleep-discrepancy-review/search_embase.csv")
...
Participants of all age groups and clinical populations were included in the review. We included any study that compared an objective measure of sleep (e.g., polysomnography, actigraphy) with an equivalent self-report measure of sleep (e.g., sleep diaries, questionnaires), through statistical analysis or composite index scores. Measures of sleep discrepancy include traditional indices of sleep time such as TST, SOL, and WASO, in addition to measures of sleep quality, sleep patterns, or any other sleep-related experience or behaviour. No records were excluded on the basis of geographic location, cultural factors, or any other contextual feature.\

## Charting the data

Methodological features of included articles were selected on their potential influence on the measurement or operational definition of sleep discrepancy and included the following: objective sleep measure, actigraphy algorithm, software, and rest interval, polysomnography setting and scoring criteria, self-report sleep measure, sleep variables and definitions thereofe, methods of handling repeated measurements, methods of comparing self-report and objective sleep within groups, and methods for operationalising sleep discrepancy at the construct level including the use of derived scores.

## Collating, summarising and reporting the results

All tables and figures summarising data were generated using computationally reproducible methods from master charting table available at (link:here). <!-- now describe how you organised the studies categories-->

# Results

The initial search of databases returned `r total_records` records that were exported to EndNote 20 [@EndNote20] where they were collated and uploaded to Rayyan [@Ouzzani2016] for deduplication and title and abstract screening. A total of `r duplicates` duplicate articles were removed. Following deduplication, two independent reviewers screened titles and abstracts to identify studies for full-text retrieval using the inclusion criteria provided above. Percentage of agreement between reviewers was 87.6% and conflicts were resolved via discussion. The full texts of articles passing title and abstract screening were screened independently by the first author with reasons for exclusion reported. Due to the unanticipated size of the literature, articles from sources other than peer-reviewed journals were added to exclusion criteria post-hoc. Studies were excluded that (i) made no direct comparisons between equivalent self-report and objective sleep measures, (ii) included informant, rather than self-report measures, (iii) were case reports or review articles, (iv) included self-report or objective measures that were not related to sleep, (v) contained no empirical data, (vi) omitted either a self-report or equivalent objective measure of sleep, (vii) were a grey literature source including theses, dissertations, and conference abstracts. Details of the review process from article identification, screening, and selection are available in the PRISMA flowchart depicted in \@ref(fig:PRISMA) below.\
...
Most studies used standard PSG or actigraphy criteria for defining objective number of awakenings (i.e., a single epoch of wakefulness). A single exception was @lewis_subjective_1969, who stipulated that a period last over a minute to count as an awakening. @neu_sleep_2007 used the same definitions for objective SE as they did for SE. 
...
```
Note, Bland Altman analyses include Bland Altman plots and the reporting of 95% limits of agreement (see: @blandaltman1999). Pitman's test (also known as the Pitman-Morgan test) is a test of differences of variances between dependent samples [@pitman1939; @morgan1939] and was was used to compare the variability of self-report and objective sleep. 
1-sample t-tests of difference scores are equivalent to paired t-tests but are included separately in the figure to reflect differences in reporting. Classification performance measures include percentage agreement, accuracy, sensitivity, specificity, positive predictive value (PPV), and negative predictive value (NPV). Formulae used for the intra-class correlation coefficent varied across studies. Spearman correlations and Wilcoxon Signed Rank Tests were often used to handle the skew of variables such as SOL and WASO. 

Other methods included the delta coefficient [@girschik_validation_2012], partial correlation and factor analysis [@regestein_self-reported_2004], errors-in-variables regression [@lauderdale_self-reported_2008], repeated measures correlation [@gibson_subjective_2023], non-parametric limits of agreement [@thurman_individual_2018], survival agreement [@guedes_comparison_2016], latent correlations for testing associations at within-subjects and between-subjects level [@feng_using_2018], and structural equation modelling [@friedmann_women_2022].
...
In this study we aimed to systematically review concepts and methods in the area of sleep discrepancy research. To map the boundaries of the concept of sleep discrepancy, we included any studies comparing objective sleep with an equivalent measure of self-report sleep. We found considerable methodological diversity across a vast literature and identified important conceptual and methodological issues across a range of areas. These are discussed below with recommendations for further research where appropriate.

## PSG and actigraphy are best used to measure different forms of sleep discrepancy

As the gold-standard for measuring objective sleep, PSG can be broadly considered preferable to actigraphy for the measurement of sleep discrepancy. 
<!-- Above will depend on sleep parameter and other things--not true--disagree--need to rephrase this section -->
In-lab attended PSG has the added benefit of allowing the monitoring of sleep in real-time for experimental awakening procedures where sleep-wake agreement can be measured directly and immediately. Perhaps most critically, in comparison with PSG, actigraphy generally overestimates sleep and underestimates wake time and can have trouble distinguishing sleep from quiescent periods of wakefulness [@marino2013]. This issue with specificity is magnified for samples experiencing chronic medical or psychiatric conditions [@conley2019agreement] and is more likely to have a greater influence on the parameters of SOL and WASO than TST (ref needed).
The advantages of actigraphy include cost-effectiveness, ease of obtaining multiple nights of recording, and reduced invasiveness relative to PSG. For these reasons, actigraphy is recommended for measuring naturalistic sleep and sleep patterns over time [@morgenthaler2007practice], and may be preferable to PSG where external validity of sleep discrepancy is a concern. A case where actigraphy clearly preferable is when aggregate (e.g., mean weekly) objective measures are compared to habitual measures of self-report sleep.

<!-- whilst PSG remains preferable for comparisons over a nightly or episodic basis. -->

<!-- Sleep discrepancy measures using PSG will hence contain less error than actigraphy, especially where self-report and objective sleep parameters are compared on a per night or per sleep episode basis.  -->

<!-- In these cases, the reliability of actigraphy estimates can be maximised by recording for over seven nights [@vansomeren2007].  -->

## Choice of actigraphy algorithm matters {#algo}

Estimation of actigraphic sleep can vary substantially according to scoring algorithm and, considered in relation to PSG, selection of algorithm will account for some error variance within sleep discrepancy. The concordance of actigraphy to PSG by algorithm tends to depend on the sample in question. For example, actiware algorithms with the medium threshold may perform better than Cole-Kripke in healthy young adults [@gao2022actigraphy]. Also, the Sadeh algorithm has demonstrated higher specificity than UCSD and Cole-Kripke [@deSouza2003further; @quante2018actigraphy; @haghayegh2019performance] but may be less appropriate for assessment of sleep in those with severe obstructive sleep apnoea [@kim2013comparison]. Further complicating the picture is the fact that algorithm performance will also differ according to the actigraph device used [@kripke2010wrist]. New algorithms identified in the review included machine learning algorithms by @john2019open and calculations of non-wear time using respiratory information by @barouni2020ambulatory and correspondence of actigraphy to PSG may be improved for these approaches. <!-- Romola: which and why?--> We noted considerable inconsistency in the reporting of actigraphy methods and algorithms were not reported in many studies. In the absence of a standardised, consensus approach to actigraphy we would like to echo the recommendations of [@ancoli2015sbsm] to report device manufacturer, device model, name and version of software, parameters of data collection including epoch length and sampling rate, and algorithms used.
...
## Sleep discrepancy varies in its conceptual distance to sleep misperception
...
Approaches to measuring and operationalising sleep discrepancy have varied considerably in the literature, often with substantial effects on what sleep discrepancy means as a concept and sometimes associated with problems that may not be immediately obvious. Measuring discrepancy or congruence is often a complex undertaking and we hope that this scoping review will prove helpful and informative to those interested in designing or interpreting sleep discrepancy studies.
...
<!-- Supplementary data to this article may be found online at xxx. -->
